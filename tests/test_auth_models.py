...
def test_create_user_normalizes_username_to_lowercase():
    ...
    user = create_user("Bob", "pass1234", first_name="B", last_name="B", phone="1", email="b@b.com")
    assert user is not None
...
def test_create_user_returns_none_for_duplicate_username():
    ...
    create_user("charlie", "pass1234", first_name="C", last_name="C", phone="1", email="c@c.com")
    second = create_user("charlie", "other", first_name="C2", last_name="C2", phone="2", email="c2@c.com")
    assert second is None


def test_create_user_returns_none_for_empty_username():
    """Empty or whitespace username returns None."""
    assert create_user("", "pass1234", first_name="X", last_name="X", phone="1", email="x@x.com") is None
    assert create_user("  ", "pass1234", first_name="X", last_name="X", phone="1", email="x@x.com") is None


def test_create_user_returns_none_for_empty_password():
    """Empty password returns None."""
    assert create_user("dave", "", first_name="D", last_name="D", phone="1", email="d@d.com") is None


def test_get_user_by_username_finds_user():
    """get_user_by_username returns user with password_hash."""
    create_user("eve", "secret123", first_name="Eve", last_name="E", phone="1", email="eve@e.com")
...
def test_get_user_by_username_case_insensitive():
    ...
    create_user("Frank", "pass1234", first_name="F", last_name="F", phone="1", email="f@f.com")
...
def test_get_user_by_id_returns_user_without_password_hash():
    ...
    created = create_user("grace", "pass1234", first_name="G", last_name="G", phone="1", email="g@g.com")
...
def test_verify_password_success():
    ...
    create_user("henry", "correcthorse", first_name="H", last_name="H", phone="1", email="h@h.com")
...
def test_verify_password_failure():
    ...
    create_user("ivan", "mypassword", first_name="I", last_name="I", phone="1", email="i@i.com")
